  ...
  return (
    <div className="space-y-5">
      <div>
        ...
        <p className="text-sm text-text-2">Sales, commission, refunds, and seller payout reporting.</p>
      </div>
      ...
      <Tabs
        ...
        selectedKey={tab}
        onSelectionChange={(key) => setTab(String(key) as keyof typeof reportRows)}
      >
      ...
      <div className="grid gap-4 md:grid-cols-3">
        <Card className="border border-border-subtle bg-surface-bg-2">
          <CardBody className="p-4">
            <p className="text-xs uppercase tracking-wide text-text-3">Primary total</p>
            <p className="text-2xl font-semibold text-viz-1">{sumA}</p>
          </CardBody>
        </Card>
        <Card className="border border-border-subtle bg-surface-bg-2">
          <CardBody className="p-4">
            <p className="text-xs uppercase tracking-wide text-text-3">Amount total</p>
