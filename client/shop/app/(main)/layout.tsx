...
const ICONS_FILLED: Record<string, React.ReactNode> = {
  ...
  clock: (
    <svg fill="currentColor" height="20" viewBox="0 0 24 24" width="20">
      <path
        clipRule="evenodd"
        d="M12 3a9 9 0 1 0 0 18A9 9 0 0 0 12 3zm1 5.5a1 1 0 0 0-2 0V12c0 .27.107.52.293.707l3 3a1 1 0 0 0 1.414-1.414L13 11.586V8.5z"
        fillRule="evenodd"
      />
    </svg>
  ),
      ...
      <header className="sticky top-0 z-40 border-b border-border-subtle bg-surface-bg-1/95 px-4 py-3 backdrop-blur-sm">
        <div className="mx-auto flex max-w-2xl items-center justify-between">
          ...
          <div className="flex items-center gap-3 text-sm text-text-2">
            {user ? (
              <>
                <span className="hidden font-medium text-text-1 sm:block">
                  {user.fullName}
                </span>
