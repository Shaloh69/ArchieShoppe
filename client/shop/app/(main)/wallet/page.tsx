    ...
    <div className="space-y-4">
      ...
      {!qrData && !paid && (
        <div className="flex items-end gap-3">
          ...
          />
          <Button className="focus-ring btn-cta mt-6 shrink-0" isLoading={loading} onPress={generate}>
            Generate QR
          </Button>
        </div>
      )}
      ...
      {qrData && !paid && !expired && (
        <div className="flex flex-col items-center gap-4 rounded-xl border border-border-subtle bg-white p-6">
          ...
          <Button size="sm" variant="flat" onPress={reset}>Cancel</Button>
        </div>
      )}
      ...
      {paid && (
        <div className="flex flex-col items-center gap-3 rounded-xl border border-status-success-400 bg-status-success-50 p-6 text-center">
          ...
          <Button size="sm" className="btn-cta" onPress={reset}>New QR</Button>
        </div>
      )}
      ...
      {expired && (
        <div className="flex flex-col items-center gap-3 rounded-xl border border-status-danger-400 bg-status-danger-50 p-6 text-center">
          ...
          <Button size="sm" className="btn-cta" onPress={reset}>Generate new QR</Button>
        </div>
      )}
    </div>
  );
...
function CashoutSection({ onRequested }: { onRequested: () => void }) {
  ...
  return (
    <div className="space-y-5">
      ...
      <Button className="focus-ring btn-cta" isLoading={loading} onPress={submit}>
        Request Cashout
      </Button>
        ...
        <CardBody className="p-4 sm:p-6">
          <Tabs aria-label="Wallet actions" color="primary" variant="underlined">
            <Tab key="qrph" title="QR Ph (InstaPay)">
              <div className="mt-4">
                <QrPhSection onPaid={() => { refreshUser(); fetchTxns(); }} />
              </div>
            </Tab>
            ...
            <Tab key="checkout" title="GCash / Card / Maya">
              <div className="mt-4 space-y-4">
                ...
                <div className="flex items-end gap-3">
                  ...
                  />
                  <Button className="focus-ring btn-cta mt-6 shrink-0" isLoading={topupLoading} onPress={onTopup}>
                    Top-up
                  </Button>
                </div>
            ...
            <Tab key="cashout" title="Cash Out">
              <div className="mt-4">
                <CashoutSection onRequested={() => { refreshUser(); fetchTxns(); }} />
              </div>
            </Tab>
          </Tabs>
        </CardBody>
