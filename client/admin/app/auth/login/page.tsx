  ...
  return (
    <div className="relative flex min-h-screen w-full items-center justify-center overflow-hidden bg-brand-primary-950 px-4">
      ...
      <div
        ...
        style={{
          backgroundImage: "linear-gradient(#ee4d2d 1px,transparent 1px),linear-gradient(90deg,#ee4d2d 1px,transparent 1px)",
      ...
      >
        ...
        <div className="mb-8 text-center">
          <div className="mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-2xl border border-brand-primary-700/60 bg-brand-primary-900 shadow-lg shadow-brand-primary-900/50">
            <svg fill="none" height="32" stroke="#ee4d2d" strokeWidth="1.5" viewBox="0 0 24 24" width="32">
          ...
          <p className="text-[11px] font-semibold uppercase tracking-[0.25em] text-brand-primary-500">UniThrift</p>
          <h1 className="mt-1 text-2xl font-extrabold text-white">Admin Console</h1>
          <p className="mt-1 text-sm text-brand-primary-400">Authorized personnel only</p>
        </div>
        ...
        <div className="overflow-hidden rounded-2xl border border-brand-primary-800/60 bg-brand-primary-900/80 shadow-2xl shadow-black/40 backdrop-blur-sm">
          <div className="px-6 pb-6 pt-5">
            <form className="space-y-4" onSubmit={onSubmit}>
              <Input
                classNames={{
                  inputWrapper: "bg-brand-primary-950/80 border border-brand-primary-700/60 data-[hover=true]:border-brand-primary-500 data-[focus=true]:border-brand-primary-400 transition-colors",
                ...
                startContent={
                  <svg className="shrink-0 text-brand-primary-500" fill="none" height="15" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24" width="15">
