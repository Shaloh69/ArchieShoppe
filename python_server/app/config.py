...
class Settings(BaseSettings):
    """UniThrift ML Service configuration."""

    app_name: str = "UniThrift AI Verification Service"
    debug: bool = False
    host: str = "0.0.0.0"
    port: int = 8001

    # API key auth (required by Node.js server)
    ...
    # Storage
    upload_dir: str = "/tmp/unithrift_uploads"
